...
public class TestEntityModel extends EntityModel<ModPathAwareEntity> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        @Override
        public void setAngles(ModPathAwareEntity entity, float limbAngle, float limbDistance, float animationProgress, float headYaw, float headPitch) {
        }
