...
import com.legumage.mctherpg.block.entity.ModBlockEntities;
import com.legumage.mctherpg.block.entity.RefineryBlockEntity;
...
public class RefineryBlock extends BlockWithEntity implements BlockEntityProvider {
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.REFINERY_BLOCK_ENTITY, RefineryBlockEntity::tick);
    }
}
